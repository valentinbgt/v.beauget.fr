...
│
├── components/
│   ├── CircularTextLink.vue   # Animated circular navigation
│   ├── ProjectModal.vue       # Project detail modal
│   └── Socials.vue            # Social media links
│
├── server/
│   ├── api/
│   │   └── contact.post.ts    # [DEPRECATED] Contact form API
│   └── routes/
...
│
├── public/
│   ├── bg-video.mp4           # Background video (custom)
│   ├── vmask.png              # Diagonal mask for video
